...
/* AnimalEconomy GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "AnimalEconomy"
#define QAPP_ORG_DOMAIN "aney.org"
#define QAPP_APP_NAME_DEFAULT "AnimalEconomy-Qt"
#define QAPP_APP_NAME_TESTNET "AnimalEconomy-Qt-testnet"
