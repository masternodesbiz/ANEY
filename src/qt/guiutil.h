...
/** Utility functions used by the AnimalEconomy Qt UI.
 */
namespace GUIUtil
{
...
// Render ANEY addresses in monospace font
...
// Parse "aney:" URI into recipient object, return true on successful parsing
