Contributing to Animaleconomy Core
============================

The Animaleconomy Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Animaleconomy Core project, and is not to be
confused with overall Animaleconomy Network Protocol consensus changes.

Whether a pull request is merged into Animaleconomy Core rests with the project merge
...
Patches that change Animaleconomy consensus rules are considerably more involved than
...
Where a patchset proposes to change the Animaleconomy consensus, it must have been
...
The project leader is the release manager for each Animaleconomy Core release.
