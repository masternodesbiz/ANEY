...
"""Verify that starting aney with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start aney with -? for help text")
        ...
        self.log.info("Start aney with -version for version information")
