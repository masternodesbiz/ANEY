...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv, expected_zpiv):
        ...
        # verify that nodes have the expected ANEY and zANEY supply
        for node in g_info:
            assert_equal(node['moneysupply'], DecimalAmt(expected_piv))
            for denom in node['zANEYsupply']:
                assert_equal(node['zANEYsupply'][denom], DecimalAmt(expected_zpiv[denom]))
    ...
    def run_test(self):
        ...
        # Check ANEY and zANEY supply at the beginning
        # ------------------------------------------
        # zANEY supply: 2 coins for each denomination
        ...
        # ANEY supply: block rewards minus burned fees for minting
        ...
        # Verify that ANEY and zANEY supplies were properly updated after the spends and reorgs
        self.log.info("Check ANEY and zANEY supply...")
