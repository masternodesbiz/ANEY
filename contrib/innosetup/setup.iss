...
#define MyAppName "Animaleconomy Core"
#define MyAppPublisher "2021-2022 The Animaleconomy Developers"
#define MyAppURL "https://github.com/TeamAnimalEconomy/animaleconomy"
#define MyAppExeName "aney-qt.exe"
#define MyAppExtraData "https://github.com/TeamAnimalEconomy/animaleconomy/releases/download/v2.0/bootstrap.zip"
...
DefaultDirName={autopf}\Animaleconomy
...
OutputDir=.\output
OutputBaseFilename=AnimaleconomySetup
...
DefaultGroupName=Animaleconomy Core
...
[Files]
Source: ".\package\aney-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Animaleconomy\Animaleconomy-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Animaleconomy\Animaleconomy-Qt,strDataDir|{userappdata}\Animaleconomy\}');
  Result := True;
end;
